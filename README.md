...
I've been passionate about computers since I was a child, and I started my IT career as a system and network administrator.
Already interested in development, I decided to switch to the "light side of the force" while I was developing a computer fleet management program with a graphical interface in PowerShell in my spare time.

After this epiphany, I started my reconversion by becoming a developer-trainer.
The variety of my interventions allowed me to acquire a wide stack, and to discover a certain interest for Agile and DevOps mentalities and practices like TDD.
These passions has been reinforced by my activity as a developer, where I was able to put them into practice.
...
- **Practices** : KISS, YAGNI, SOLID, DRY
...
- **Practices** : ATDD
- **Architecture** : Clean Code, Clean Architecture, DDD, Hexagonal Architecture, Micro Frontends
...
This time, it's no longer a script with a graphical interface, but a complete web application, with a REST API and a user interface.
...
Déjà très intéressé par le développement, j'ai décidé de passer du "coté clair de la force" alors que je développais un programme de gestion de parc informatique avec interface graphique en PowerShell pendant mon temps libre.

Après cette épiphanie, j'ai entamé ma reconversion en devenant formateur en développement.
La variété de mes interventions m'a permis d'acquérir une stack large, et de me découvrir un intérêt certain pour les mentalités Agile et DevOps et des pratiques comme la TDD.
...
#### 🎉 Je connais des usages avancés de ...
...
Ce projet est la continuité de mon tout premier projet de dev : le script PowerShell de gestion de parc informatique.
Cette fois, il ne s'agit plus d'un script avec interface graphique, mais d'une application web complète, avec une API REST et une interface utilisateur.
